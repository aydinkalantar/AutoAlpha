...
export default function LiveRadar({ openPositions: initialPositions, isPaperMode }: LiveRadarProps) {
    ...
    if (openPositions.length === 0) {
        return (
            <div className="w-full bg-white/50 dark:bg-white/5 backdrop-blur-2xl border border-black/5 dark:border-white/10 rounded-2xl shadow-sm text-center py-16 px-6 relative overflow-hidden group">
