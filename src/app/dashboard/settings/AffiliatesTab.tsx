        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
            ...
            <div className="relative z-10">
                <div className="bg-white/50 dark:bg-white/5 backdrop-blur-2xl border border-black/5 dark:border-white/10 rounded-[2rem] p-8 max-w-2xl shadow-xl">
                    ...
                    <p className="text-foreground/60 mb-6 max-w-lg leading-relaxed">
                        Earn a <strong className="text-emerald-500 font-black">20% continuous commission</strong> on all performance fees generated by your referred network.
                    </p>
            ...
            <div className="relative z-10 pt-8">
                <Card className="bg-white/50 dark:bg-white/5 backdrop-blur-2xl border-black/5 dark:border-white/10 rounded-[2rem] shadow-xl overflow-hidden">
                    <CardHeader className="pb-4">
                        <CardTitle className="text-xl font-bold text-foreground">Recent Commission Payouts</CardTitle>
                    </CardHeader>
                    <CardContent>
                        {affiliateLedgers.length === 0 ? (
                            <div className="text-center p-12 bg-white/5 dark:bg-black/20 rounded-3xl border border-black/5 dark:border-white/5 border-dashed flex flex-col items-center justify-center">
                                <Gift className="w-12 h-12 text-foreground/20 mb-4" />
                                <p className="text-foreground/40 font-medium tracking-wide">No commissions earned yet. Start sharing your code!</p>
                            </div>
                        ) : (
