        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-white rounded-[2rem] border border-black/5 p-6 h-[600px] overflow-y-auto space-y-4 shadow-sm shadow-black-[0.03]">
                        ...
                        {data.positions.map((pos) => (
                            <div key={pos.id} className="border border-black/5 rounded-xl p-5 hover:bg-black/[0.02] transition-colors relative overflow-hidden">
                                {pos.isOpen && (
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm mt-4 border-t border-black/5 pt-4">
                                    <div>
                                    ...
                                    {(!pos.isOpen && pos.realizedPnl !== undefined) && (
                                        <div className="col-span-2 mt-2 bg-black/[0.02] p-3 rounded-xl border border-black/5 flex justify-between items-center">
