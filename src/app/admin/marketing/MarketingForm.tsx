        ...
        <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
            ...
            <div className="bg-white/40 dark:bg-white/5 backdrop-blur-2xl rounded-[2.5rem] p-8 border border-black/5 dark:border-white/10 shadow-2xl shadow-black/5 dark:shadow-black/20">
                ...
                <div className="space-y-6">
                    ...
                    <div className="flex items-center justify-between p-4 rounded-2xl bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 mt-8">
                        <div className="space-y-1">
                            <h3 className="font-semibold text-lg">Affiliate Partner Program</h3>
                            <p className="text-sm text-foreground/60 w-3/4">Global commission rate paid to referring users as a continuous percentage of all performance fees generated by their network.</p>
                        </div>
                    </div>
