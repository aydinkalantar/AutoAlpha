...
export default function CreateStrategyForm() {
    ...
    return (
        <div className="p-8 relative overflow-hidden bg-white/50 dark:bg-black/20 backdrop-blur-xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                    <div className="space-y-2">
                        ...
                        <input
                            ...
                            name="name"
                            required
                            className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-[1.2rem] px-5 py-4 text-foreground placeholder-muted-foreground focus:outline-none focus:border-primary focus:bg-background focus:ring-2 focus:ring-primary/20 transition-all font-medium"
                    ...
                    <div className="space-y-2">
                        ...
                        <select
                            ...
                            className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-[1.2rem] px-5 py-4 text-foreground focus:outline-none focus:border-primary focus:bg-background focus:ring-2 focus:ring-primary/20 transition-all font-medium appearance-none"
                        >
