        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 md:pl-64">
            ...
            <div className="relative w-full max-w-md bg-white/80 dark:bg-white/5 backdrop-blur-3xl border border-white/40 dark:border-white/10 rounded-[2.5rem] shadow-2xl p-8 overflow-hidden z-10 transition-all">
                <div className="flex justify-between items-center mb-8">
                    ...
                    <button onClick={onClose} className="w-10 h-10 rounded-full bg-black/5 dark:bg-white/5 hover:bg-black/5 dark:hover:bg-white/10 flex items-center justify-center text-foreground/40 hover:text-foreground transition-colors" disabled={isSubmitting} title="Close modal" aria-label="Close modal">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="text-sm font-medium text-foreground/50 bg-black/5 dark:bg-white/5 px-4 py-3 rounded-[1rem]">
                    ...
                    <div className="space-y-3">
                        ...
                        <input
                            ...
                            step="0.01"
                            placeholder="0.00"
                            className="w-full bg-black/5 dark:bg-white/5 border border-transparent rounded-[1.2rem] px-5 py-4 text-foreground placeholder-foreground/30 focus:outline-none focus:border-black/10 dark:focus:border-white/10 focus:bg-white dark:focus:bg-[#1C1C1E] focus:ring-2 focus:ring-black/5 dark:focus:ring-white/10 transition-all font-mono font-bold text-lg"
                        />
                    </div>
                    ...
                    <div className="space-y-3">
                        ...
                        <textarea
                            ...
                            rows={3}
                            className="w-full bg-black/5 dark:bg-white/5 border border-transparent rounded-[1.2rem] px-5 py-4 text-foreground placeholder-foreground/30 focus:outline-none focus:border-black/10 dark:focus:border-white/10 focus:bg-white dark:focus:bg-[#1C1C1E] focus:ring-2 focus:ring-black/5 dark:focus:ring-white/10 transition-all font-medium resize-none"
                        />
                    </div>
