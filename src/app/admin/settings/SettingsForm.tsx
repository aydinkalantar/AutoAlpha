    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-8">
            <div className="bg-white/50 dark:bg-black/40 backdrop-blur-2xl border border-black/5 dark:border-white/10 rounded-[2rem] shadow-2xl p-8 shadow-black/[0.03] space-y-8 relative overflow-hidden">
                ...
                {/* TEST KEYS */}
                <div className={`space-y-6 pt-6 border-t border-black/5 transition-opacity ${mode === 'TEST' ? 'opacity-100' : 'opacity-40'}`}>
                ...
                {/* LIVE KEYS */}
                <div className={`space-y-6 pt-6 border-t border-black/5 transition-opacity ${mode === 'LIVE' ? 'opacity-100' : 'opacity-40'}`}>
